...
par(mfrow=c(2,3), mar = c(5.1, 4.1, 7.1, 2.1), oma = c(0,1,))
...
![**Figure 7:** 95% confidence bands for the mean percentage of individuals with a personal doctor as predicted by our fitted model for the five year averages. The plot on the right shows the models for each individual year plotted superimposed over the 95% confidence band for the five year averages model.](plots/mod_conf.png)
