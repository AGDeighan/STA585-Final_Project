...
t11.data <- data.frame(read.csv("Cleaned 2011 BRFSS Data.csv"))[,2:5]
t12.data <- data.frame(read.csv("Cleaned 2012 BRFSS Data.csv"))[,2:5]
t13.data <- data.frame(read.csv("Cleaned 2013 BRFSS Data.csv"))[,2:5]
t14.data <- data.frame(read.csv("Cleaned 2014 BRFSS Data.csv"))[,2:5]
t15.data <- data.frame(read.csv("Cleaned 2015 BRFSS Data.csv"))[,2:5]
...
counter <- function(x){
  ...
  out <- matrix(data = NA, 
                ...
                ncol = 4)
  colnames(out) <- c("State", "Personal Doctor Count", "Insurance Count", "Total Respondents")
