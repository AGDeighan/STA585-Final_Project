...
<br>
 ...
 Table 12 reports the estimated slope and its 95% confidenct interval for each model. Recall that the repsonse variable is the number of individuals with a personal doctor per 100 respondents and the explanatory variable is the number of individuals with insurance per 100 respondents. Assuming that the BRFSS is a representative sample, we can then view the response variable as the estimated percentage of individuals with a personal doctor in a state while the explanatory variable is the estimated percentage of individuals with insurance in a state. Thus the estimated slope coefficient of 0.01277 (2015 model) implies that for a 1 percentage increase in individuals with insurance we should expect a $e^(0.01277) = 1.013 $ fold increase in the percentage of individuals with a personal doctor. While this may not seem like a large difference, when considering large populations it can be quite significant.
